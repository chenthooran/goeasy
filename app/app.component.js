System.register(['@angular/core', '@angular/router', '@angular/common', './services/auth.service', './services/token.service', './notes/add-note.component', './tasks/add-task.component', './timeline/timeline.component', './authentication/login.component', './app.constants', './tags/tags.component', './tags/add-tag.component', './userprofile/userprofile.component', './recenttimeline/recenttimeline.component', './dashboard/dashboard.component', './notifications/notifications.component', './feedback/feedback.component', './services/feedback.service', './tags/tag-detail.component', './loader/loading.component'], function(exports_1, context_1) {
    ...
    var core_1, core_2, router_1, common_1, auth_service_1, token_service_1, add_note_component_1, add_task_component_1, timeline_component_1, login_component_1, app_constants_1, tags_component_1, add_tag_component_1, userprofile_component_1, recenttimeline_component_1, dashboard_component_1, notifications_component_1, feedback_component_1, feedback_service_1, tag_detail_component_1, loading_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (add_task_component_1_1) {
                add_task_component_1 = add_task_component_1_1;
            },
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.Routes([
                        ...
                        {
                            path: '/addTask',
                            component: add_task_component_1.AddTaskComponent
                        },
                        {
                            path: '/timeline',
