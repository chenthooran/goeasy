...
.ui-widget .ui-widget {font-size: 1em;box-shadow: 0px 0px 1px rgba(0,0,0,0.12), 0 1px 0px rgba(0,0,0,0.24);border-radius: 0px;padding: 3px;margin-top: 12px;margin-bottom: -6px;}
